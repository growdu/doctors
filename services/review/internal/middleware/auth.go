...
func UserID(c *gin.Context) int64 { v, _ := c.Get(UserIDKey); id, _ := v.(int64); return id }
func Role(c *gin.Context) string   { v, _ := c.Get(RoleKey); s, _ := v.(string); return s }
